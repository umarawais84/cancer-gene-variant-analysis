...
def create_split_graph() -> plt.Figure:
    ...
    for var_idx in range(len(variant_labels)):
        ...
        for sequencer in SEQUENCERS:
            ...
            segment_height = early_data[sequencer][var_idx] / total_seqs
    ...
    for var_idx in range(len(variant_labels)):
        ...
        for sequencer in SEQUENCERS:
            ...
            segment_height = late_data[sequencer][var_idx] / total_seqs
    ...
    legend_elements = [Patch(facecolor=colors[seq], edgecolor='white', label=seq) for seq in SEQUENCERS]
